#!/usr/bin/env python3
"""Bilinear attention + BatchNorm, NO BIASES variant (d=512, ctx=512).
...
Usage:
    python train_bilinear_bn_nobias_ctx512_d512.py
    python train_bilinear_bn_nobias_ctx512_d512.py --batch-size 96
"""
import math
import json
import time
...
def main(batch_size=64, use_compile=True):
    ...
    print(f"=== Bilinear + BatchNorm + NO BIAS: ctx={N_CTX}, d={d_model} ===")
    ...
    run_dir = Path(f"runs/{timestamp}_bilinear_bn_nobias_ctx512_d512")
