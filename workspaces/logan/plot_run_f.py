#!/usr/bin/env python3
"""Plot induction metrics for Run F (SimpleStories)."""
import json
import matplotlib.pyplot as plt

metrics_path = "runs/2026-02-13_221438_bilinear_bn_nobias_ss_ctx512_d512/metrics.jsonl"
...
fig.suptitle("Run F: Bilinear+BN, No Bias, SimpleStories (d=512, ctx=512)", fontsize=14, fontweight="bold")
...
plt.tight_layout()
plt.savefig("induction_results/run_F_induction_plot.png", dpi=150, bbox_inches="tight")
print(f"Saved: induction_results/run_F_induction_plot.png")
