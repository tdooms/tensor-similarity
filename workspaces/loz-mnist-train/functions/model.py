...
class Model(PreTrainedModel):
    def __init__(self, config) -> None:
        ...
        self.blocks = nn.ModuleList([
            Bilinear(d_embed, d_hidden, bias=bias) 
    ...
    def fit(self, train, test, transform=None, record_every_n_batches=None, save_checkpoints=False):
        ...
        # Save initialization checkpoint (batch 0)
        if save_checkpoints:
            ...
            # Add to history
            history.append({
                "train/loss": 0.0,  # No training yet
                "train/acc": 0.0,   # No training yet
        ...
        for epoch in pbar:
            ...
            for batch_idx, (x, y) in enumerate(loader):
                ...
                scheduler.step() # Step the scheduler every batch for smoother learning rate decay
