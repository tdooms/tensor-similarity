...
VARIANTS = [
    ...
    {"name": "norm_mlp_unembed", "init_type": "normal", "attn_type": "bilinear", "norm_places": ["pre_mlp", "pre_unembed"]},
    {"name": "norm_attn_unembed", "init_type": "normal", "attn_type": "bilinear", "norm_places": ["pre_attn", "pre_unembed"]},
    {
        "name": "norm_all",
        "init_type": "normal",
        "attn_type": "bilinear",
...
def main():
    ...
    ap.add_argument("--group", default="sweep_arch_train")
    args = ap.parse_args()
