#!/usr/bin/env python3
"""Plot empirical layer-1 head heatmaps, individually and as a compact grid."""
...
def main():
    ...
    parser.add_argument("--input", required=True, help="Path to empirical_l1_head_sims.npz")
    ...
    key = "empirical_head_values" if args.raw else "empirical_head_local_sims"
    values = data[key]
    mode = "raw" if args.raw else "local"
    output_dir = Path(args.output_dir) if args.output_dir else input_path.with_suffix("").parent / "empirical_l1_head_heatmaps"
